...
> [!IMPORTANT]  
> What's the difference between this version and the original `winston-loki`? This version was forked from `v6.1.3` due to it's speed of maintenance and crucial missing features like better error handling.
